    ...
    return (
        <div>
            ...
            <Paper elevation={0} sx={{backgroundColor:'#333333',px:2,py:2}} children={
                <Box>
                    <Box sx={{ display: 'flex', alignItems: 'center',justifyContent:'space-evenly' ,pb:1 }}> <img src="https://img.alicdn.com/imgextra/i1/O1CN01h1du8I1IZRwJhj11v_!!6000000000907-2-tps-102-36.png" width='50px' alt="" />
                        <Typography noWrap sx={{ fontWeight: 'bold',fontSize:15, color: '#f2cb8e'}}>
                            Pro Buyer Exclusive
                        </Typography>
                    </Box>


                    <Typography noWrap align={'center'} sx={{ fontSize: 11, color: '#f2cb8e',pb:1 }}>
